...
if(!empty($_GET['documentos_id']))
{
    include_once('config.php');

    $documentos_id =$_GET['documentos_id'];

    $sql6 = "SELECT * FROM documentos WHERE documentos_id=$documentos_id";
...
<head>
    ...
    <title>ZCOND</title>
    <link rel="stylesheet" href="documento-editar.css">
...
<main>
        ...
        <a class='exibir' href='documento.php' title='Editar'>VOLTAR</a>
    </div>
