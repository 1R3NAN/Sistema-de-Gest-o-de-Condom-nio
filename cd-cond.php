...
if(isset($_POST['submit']))
{
    ...
    $cpf_fundador = $_POST['cpf_fundador'];
    $cnpj_condominio = $_POST['cnpj_condominio'];
    $cep = $_POST['cep'];
    $apartamentos = $_POST['apartamentos'];

    $sql_code = "INSERT INTO condominios(nome_condominio, fundador_condominio, cpf_fundador, cnpj_condominio, cep, apartamentos) 
    VALUES('$nome_condominio','$fundador_condominio', '$cpf_fundador', '$cnpj_condominio', '$cep','$apartamentos')";
        ...
        <form action="cd-cond.php" method="POST" class="cadastramento">
            ...
            <div class="cadastro">
                <div class="registro1">
                    ...
                    <label>CNPJ</label>
                    <input type="text" name="cnpj_condominio" autocomplete="off" required maxlength="14"/>
                    <label>CEP</label>
                    <input type="text" name="cep" autocomplete="off" required maxlength="8"/>
                    <label>Nome do Fundador</label>
                    <input type="text" name="fundador_condominio" autocomplete="off" required maxlength="30"/>
                    <label>CPF</label>
                    <input type="text" name="cpf_fundador" autocomplete="off" required maxlength="11"/>
                    <div clas="isso">
